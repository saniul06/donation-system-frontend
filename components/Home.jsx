...
const Home = () => {
    ...
    const { loading, success, error, donation } = useSelector(state => state.donation);
    ...
    const handleDonation = (e) => {
        ...
        dispatch(createDonation({ category, amount: parsedAmount, contact }))
        setCategory('');
        setAmount(0);
        setContact('');
    }
                        ...
                        <div className="col-lg-12">
                            <form id="search-form" name="gs" method="submit" role="search" action="#">
                                <div className="row">
                                    ...
                                    <div className="col-lg-3 align-self-center">
                                        <fieldset>
                                            <input value={amount} onChange={e => setAmount(e.target.value)} type="number" className="searchText"
