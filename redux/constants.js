...
export const DONATION_SUMMARY_REQUEST = 'DONATION_SUMMARY_REQUEST'
export const DONATION_SUMMARY_SUCCESS = 'DONATION_SUMMARY_SUCCESS'
export const DONATION_SUMMARY_FAIL = 'DONATION_SUMMARY_FAIL'

export const SELECT_DONATION = 'SELECT_DONATION'
export const LOAD_MORE_ALL_DONATION = 'LOAD_MORE_ALL_DONATION'
export const LOAD_MORE_MY_DONATION = 'LOAD_MORE_MY_DONATION'
export const CATEGORY_FILTER_ALL_DONATION = 'CATEGORY_FILTER_ALL_DONATION'
export const CATEGORY_FILTER_MY_DONATION = 'CATEGORY_FILTER_MY_DONATION'
